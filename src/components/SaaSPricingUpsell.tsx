  ...
  return (
    <div className="bg-[#121212] border border-white/8 rounded-2xl p-10 text-center space-y-6 max-w-xl mx-auto shadow-sm my-4" id="saas-upsell-container">
      ...
      <div className="space-y-3 max-w-md mx-auto">
        <h3 className="font-serif font-black text-2xl text-white">Thoughtful spaces require preparation</h3>
      ...
      <div className="bg-[#181818] p-6 rounded-2xl border border-white/8 flex flex-col sm:flex-row items-center justify-between text-left gap-4">
        ...
        <button
          onClick={() => {
            UnifiedFashionOS.setSubscriptionTier('Pro');
          }}
          className="bg-white hover:bg-neutral-200 text-black font-mono text-xs font-bold py-3.5 px-6 rounded-xl uppercase tracking-wider cursor-pointer transition-all shrink-0 w-full sm:w-auto text-center"
        >
          Try Premium Free
        </button>
      </div>

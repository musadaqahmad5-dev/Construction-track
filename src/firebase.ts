...
import { getFirestore, collection, addDoc, query, where, onSnapshot, deleteDoc, doc, getDocs, serverTimestamp, enableIndexedDbPersistence } from 'firebase/firestore';
...
// Enable offline persistence for web clients safely
